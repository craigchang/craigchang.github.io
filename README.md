# craigchang.github.io

Personal portfolio site for Craig Chang, a software engineer based in the Bay Area.

## Content

- **About** — Introduction, bio, skills (languages, tools, frameworks), Beyond the Code (hobbies and interests), and social links (LinkedIn, GitHub)
- **Portfolio** — Project showcase (see table below)

### Portfolio Projects

| Project | Link | Description | Repo |
|---------|------|-------------|------|
...
- **Jekyll** — Static site generator; Markdown content and Liquid templates compiled into static HTML
- **GitHub Pages** — Hosting and deployment
- **SASS/SCSS** — Styling with modular partials (layout, components, highlights, etc.)
- **Kramdown** — Markdown parsing with GFM support
- **Liquid** — Templating for layouts, includes, and data-driven sections
- **jekyll-sitemap** — Sitemap generation for SEO
